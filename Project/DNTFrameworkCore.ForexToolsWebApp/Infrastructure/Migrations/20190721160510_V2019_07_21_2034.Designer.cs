...
namespace DNTFrameworkCore.ForexToolsWebApp.Infrastructure.Migrations
{
    ...
    [Migration("20190721160510_V2019_07_21_2034")]
    partial class V2019_07_21_2034
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DNTFrameworkCore.ForexToolsWebApp.Domain.Catalog.Product", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("DNTFrameworkCore.ForexToolsWebApp.Domain.Identity.Permission", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("DNTFrameworkCore.ForexToolsWebApp.Domain.Identity.Role", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("DNTFrameworkCore.ForexToolsWebApp.Domain.Identity.RoleClaim", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("DNTFrameworkCore.ForexToolsWebApp.Domain.Identity.User", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("DNTFrameworkCore.ForexToolsWebApp.Domain.Identity.UserClaim", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("DNTFrameworkCore.ForexToolsWebApp.Domain.Identity.UserRole", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("DNTFrameworkCore.ForexToolsWebApp.Domain.Identity.RolePermission", b =>
                {
                    b.HasBaseType("DNTFrameworkCore.ForexToolsWebApp.Domain.Identity.Permission");
            ...
            modelBuilder.Entity("DNTFrameworkCore.ForexToolsWebApp.Domain.Identity.UserPermission", b =>
                {
                    b.HasBaseType("DNTFrameworkCore.ForexToolsWebApp.Domain.Identity.Permission");
            ...
            modelBuilder.Entity("DNTFrameworkCore.ForexToolsWebApp.Domain.Identity.RoleClaim", b =>
                {
                    b.HasOne("DNTFrameworkCore.ForexToolsWebApp.Domain.Identity.Role", "Role")
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("DNTFrameworkCore.ForexToolsWebApp.Domain.Identity.UserClaim", b =>
                {
                    b.HasOne("DNTFrameworkCore.ForexToolsWebApp.Domain.Identity.User", "User")
                        .WithMany("Claims")
