...
namespace DNTFrameworkCore.ForexToolsWebApp.Authorization
{
    public class AuthorizationProvider : IAuthorizationProvider
    {
        ...
        {
            return new LocalizableString(name, "SharedResource") { ResourceLocation = "DNTFrameworkCore.ForexToolsWebApp" };
        }
    }
}