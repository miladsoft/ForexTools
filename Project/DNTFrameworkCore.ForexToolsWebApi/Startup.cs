...
using DNTFrameworkCore.ForexToolsWebApi.Application;
using DNTFrameworkCore.ForexToolsWebApi.Hubs;
using DNTFrameworkCore.ForexToolsWebApi.Infrastructure;
...
namespace DNTFrameworkCore.ForexToolsWebApi
{
