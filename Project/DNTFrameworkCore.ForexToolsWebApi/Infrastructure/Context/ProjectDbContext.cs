...
using DNTFrameworkCore.ForexToolsWebApi.Infrastructure.Mappings.Blogging;
using DNTFrameworkCore.ForexToolsWebApi.Infrastructure.Mappings.Identity;
using DNTFrameworkCore.ForexToolsWebApi.Infrastructure.Mappings.Tasks;
using EFSecondLevelCache.Core.Contracts;
using Microsoft.EntityFrameworkCore;
using Microsoft.EntityFrameworkCore.Infrastructure;

namespace DNTFrameworkCore.ForexToolsWebApi.Infrastructure.Context
{
